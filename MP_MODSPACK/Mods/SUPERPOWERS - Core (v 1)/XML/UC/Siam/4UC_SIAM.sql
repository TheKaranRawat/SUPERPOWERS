...
SELECT	'UNIT_3ROYALRIFLE',	Class,	  PrereqTech, RangedCombat, Range, Special, 50, 55, Cost, ObsoleteTech, GoodyHutUpgradeUnitClass, FaithCost, RequiresFaithPurchaseEnabled, 3, CombatClass, Domain, DefaultUnitAI, 'TXT_KEY_UNIT_3ROYALRIFLE_HELP','TXT_KEY_UNIT_3ROYALRIFLE', 'TXT_KEY_UNIT_3ROYALRIFLE_TEXT',	'TXT_KEY_UNIT_3ROYALRIFLE_STRATEGY',  	Pillage, MilitarySupport, MilitaryProduction, IgnoreBuildingDefense, Mechanized, AdvancedStartCost, RangedCombatLimit, CombatLimit, XPValueDefense, 'ART_DEF_UNIT_3ROYALRIFLE',	0,					'3SIAMSOLD_FLAG',					  0, 				'3ROYALRIFLE_ATLAS',	 MoveRate
